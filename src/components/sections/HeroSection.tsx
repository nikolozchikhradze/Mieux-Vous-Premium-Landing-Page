...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen min-h-[700px] w-full overflow-hidden bg-brand-bg pt-20">
      ...
      >
        <img
          ...
          loading="eager"
          className="w-full h-full object-cover opacity-[0.25] ken-burns"
        />
      ...
      >
        ...
        <ChevronDown size={16} className="text-brand-accent animate-bounce" />
      </motion.div>
    </section>
  );
};
